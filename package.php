...
<head>
   ...
   <title>courses_mandatorytrendz</title>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
                        <div class="single-card text-center mb-30">
                            ...
                            <div class="card-bottom">
                                ...
                                <div class="modal fade" id="mymodel3" >
                                        ...
                                        <div class="modal-content">
                                            <!-- Model try -->
                                                ...
                                                <div class="modal-body">
                                                    <h1 class="text-primary" ><?php echo $row["course_name"];?><br></h1>
                                                    <h2 class="text-left text-sucess">About: <br></h2>
                                                    <h3 class="text-left text-secondary" ><?php echo $row["course_desc"];?></h3>
                                                    <h2 class="text-left text-sucess">Duration: <br></h2>
                                                    <h3 class="text-left text-secondary" ><?php echo $row["course_duration"];?></h3>
                                                    <h2 class="text-left text-sucess">Syllabus: <br></h2>
                                                    <h3 class="text-left text-secondary" ><?php echo $row["syllabus"];?></h3>
                                                    <h2 class="text-left text-sucess">Payment Link: <br></h2>
                                                    <h3 class="text-left text-secondary" ><?php echo $row["payment_link"];?></h3>
                                                </div>
